...
def show_packet8m_viewer(mw):
    ...
    def _redraw_chart():
        ...
        # y-axis arrowhead (up)
        qp.drawLine(ml, mt - 4, ml - 3, mt + 2)
        qp.drawLine(ml, mt - 4, ml + 3, mt + 2)
        # x-axis arrowhead (right)
        qp.drawLine(pw - mr + 4, ph - mb, pw - mr - 2, ph - mb - 3)
        qp.drawLine(pw - mr + 4, ph - mb, pw - mr - 2, ph - mb + 3)
        ...
        qp.drawText(ml + 4, mt + 14, "xenc")
        tw = qp.fontMetrics().horizontalAdvance("col")
        qp.drawText(pw - mr - tw, ph - mb - 4, "col")
        qp.end()
